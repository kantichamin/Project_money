...
void TaxFam::UpdateN() {
	...
	if (mainpanel) mainpanel->FamilyDeduction = n;
}

TaxFam::TaxFam(wxWindow* parent, main* main_panel):wxPanel(parent, wxID_ANY) {
	...
	panelfund = new TaxFund(this, mainpanel, this);
