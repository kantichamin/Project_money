...
TaxFam::TaxFam(wxWindow* parent, wxPanel* main_panel):wxPanel(parent, wxID_ANY) {
	...
	wxTextCtrl* ownan = new wxTextCtrl(owna, wxID_ANY, wxString::FromUTF8(""));
	...
	wxCheckBox* cbpa1 = new wxCheckBox(parant, wxID_ANY, wxString::FromUTF8("บิดา"));
	cbpa1->SetForegroundColour(*wxWHITE);
	wxCheckBox* cbpa2 = new wxCheckBox(parant, wxID_ANY, wxString::FromUTF8("มารดา"));
	...
	wxCheckBox* cbpama1 = new wxCheckBox(parantma, wxID_ANY, wxString::FromUTF8("บิดา"));
	cbpama1->SetForegroundColour(*wxWHITE);
	wxCheckBox* cbpama2 = new wxCheckBox(parantma, wxID_ANY, wxString::FromUTF8("มารดา"));
	...
	wxCheckBox* cbchri1 = new wxCheckBox(chrip, wxID_ANY, wxString::FromUTF8("บิดา"));
	cbchri1->SetForegroundColour(*wxWHITE);
	wxCheckBox* cbchri2 = new wxCheckBox(chrip, wxID_ANY, wxString::FromUTF8("มารดา"));
	...
	wxCheckBox* cbchri4 = new wxCheckBox(chrip, wxID_ANY, wxString::FromUTF8("ญาติ (เช่น พี่,น้อง ฯลฯ)"));
	...
	wxCheckBox* cbchrima1 = new wxCheckBox(chripma, wxID_ANY, wxString::FromUTF8("คู่สมรส"));
	cbchrima1->SetForegroundColour(*wxWHITE);
	wxCheckBox* cbchrima2 = new wxCheckBox(chripma, wxID_ANY, wxString::FromUTF8("บิดา"));
	cbchrima2->SetForegroundColour(*wxWHITE);
	wxCheckBox* cbchrima3 = new wxCheckBox(chripma, wxID_ANY, wxString::FromUTF8("มารดา"));
	...
	wxListBox* myChoice = new wxListBox(panelfam, wxID_ANY, wxDefaultPosition, wxDefaultSize, choices);
	...
	child->Hide();
	wxCheckBox* cbchildT = new wxCheckBox(child1, wxID_ANY, wxString::FromUTF8("มี"));
	...
	wxTextCtrl* ch2561bf = new wxTextCtrl(childbefore, wxID_ANY, wxString::FromUTF8(""));
	...
	wxTextCtrl* ch2561af = new wxTextCtrl(childafter, wxID_ANY, wxString::FromUTF8(""));
	ch2561af->SetBackgroundColour(wxColour(200, 200, 200));

	wxStaticText* chinfrim = new wxStaticText(childinfrim, wxID_ANY, wxString::FromUTF8("จำนวนบุตรที่เกิดตั้งแต่ปี 2561 เป็นต้นไป  : "));
	chinfrim->SetForegroundColour(*wxWHITE);
	wxTextCtrl* childhowinfrim = new wxTextCtrl(childinfrim, wxID_ANY, wxString::FromUTF8(""));
